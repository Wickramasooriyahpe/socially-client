...
function DashCreativeTable(props) {
...
/******************A P I INTEGRATION to  GET creative table**************/
    ...
    const getData = () => {
        ...
        axios.get("http://localhost:3000/dashboard/admin/creatives/"+adverId,config).then((res) =>{
     ...
     async function deleteOperation (creativeId){
        ...
        let result = await fetch('http://localhost:3000/dashboard/admin/creatives',{
          method: 'get',
...
export default DashCreativeTable;